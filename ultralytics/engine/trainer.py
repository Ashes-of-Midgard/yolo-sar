...
def convert_to_adv(Trainer:BaseTrainer):
    """Convert a trainer to its adversarial counter parts"""
    class AdvTrainer(Trainer):
        def __init__(self, adv_factor=0.03, training_clean=True, *args, **kwargs):
            super().__init__(*args, **kwargs)
            self.adv_factor = adv_factor
            self.training_clean = training_clean
