...
class C2fPPA(nn.Module):
    """C2f module with parallelized patch-aware attention module."""
...
class C3k2PPA(C2fPPA):
    """C23k module with parallelized patch-aware attention."""
