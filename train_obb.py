...
if __name__=="__main__":
    ...
    model = YOLO("yolo12m-obb-wtconv.yaml", task="obb")
    ...
    # 用自定义的SAR数据集训练/微调
    results = model.train(data="/root/yolo-sar/datasets/competition-2/dataset.yaml", epochs=300, amp=True, batch=8, device=1) # 不建议开启混合精度，非常容易出现数据溢出
